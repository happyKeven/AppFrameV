package com.appframe.module.materialdesign.tablelayout.bottomnavigationbar;
...
public class TabLayoutActivity extends BaseFrame {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// setContentView(R.layout.tablayout_bottom_navigationbar);
		mViewStub.setLayoutResource(R.layout.tablayout_bottom_navigationbar);
		mViewStub.inflate();
